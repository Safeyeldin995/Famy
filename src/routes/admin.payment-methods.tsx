                  ...
                  {editingId === m.id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => submitEdit(m)} disabled={update.isPending} className="focus-ring rounded-lg bg-brand px-3 py-1.5 text-xs font-bold text-brand-foreground disabled:opacity-50">
