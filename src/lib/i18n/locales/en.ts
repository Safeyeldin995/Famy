const en = {
  ...
  preview: {
    ...
    splashDesc: "Animated Famy logo on pink",
    onboarding: "Onboarding",
    onboardingDesc: "3-step intro with illustrations",
    registration: "Registration",
    registrationDesc: "Sign in & sign up — new design",
    homeDesc: "Customer home — categories & featured pros",
    provider: "Provider profile",
    providerDesc: "Pink hero, week availability & reviews",
    booking: "Book a pro",
    bookingDesc: "Merged schedule — date & time dropdowns",
    bookingsDesc: "Upcoming visits & history tabs",
    addressesDesc: "Saved places — list, add & edit",
    profileDesc: "Account hub with pink hero",
    addressNew: "Add address",
    addressEdit: "Edit address",
    otp: "OTP verification",
    setup: "Profile setup",
    chat: "Chat thread",
    groupLaunch: "Launch & sign-up",
    groupDiscover: "Discover & book",
    groupTabs: "Main tabs",
  ...
  auth: {
    ...
    signupVerifyTitle: "Verify your signup",
    signupVerifyBody: "Enter the code we sent to finish creating your account.",
    resetVerifyTitle: "Verify password reset",
    resetVerifyBody: "Enter the code we sent to reset your password.",
    codeExpiresIn: "Code expires in",
    changePhone: "Change phone number",
    confirmPassword: "Confirm password",
    passwordsMatch: "Passwords match",
    resetPasswordTitle: "Set a new password",
    otpInputLabel: "Six-digit verification code",
    otpDigitLabel: "Digit {{position}} of {{total}}",
  ...
  profile: {
    ...
    promoCodesSub: "Offers & history",
  },
  promoCodes: {
    title: "Promo codes",
    available: "Available for you",
    availableEmpty: "No promo codes right now",
    availableEmptyBody: "Check back later for new offers.",
    history: "Used codes",
    historyEmpty: "No promo codes used yet",
    historyEmptyBody: "Codes you redeem on bookings will show up here.",
    used: "Used",
  ...
  category: {
    ...
    emptyBody:
      "No eligible professionals for this service right now. Try another service or check back later.",
  },
  provider2: {
  ...
  providerProfile: {
    ...
    noAvailability: "Weekly schedule will appear here once published.",
    todayLabel: "Today",
    closedDay: "Not available on this day",
    availabilityHint: "These are usual working hours. Exact slots are confirmed when you book.",
    reviewsCount: "Reviews ({{count}})",
    reviewsOnly: "Reviews",
    noReviews: "No reviews yet.",
    anonymous: "Famy customer",
  ...
  providerCard: {
    ariaLabel: "{{name}}, {{rating}} stars",
    ariaLabelDetailed: "{{name}}, {{rating}} stars, {{price}}",
  },
  notifs: {
    title: "Notifications",
    empty: "You're all caught up",
  ...
  bookFlow: {
    ...
    slotsLoadError: "Could not load available times. Try another date or retry.",
    noServices: "This professional hasn't published services yet.",
    travelFee: "Travel fee",
    durationShort: "{{hours}}h",
    ...
    failed: "Could not create booking",
    errors: {
      SLOT_UNAVAILABLE: "That time slot is no longer available. Please pick another time.",
    ...
    scheduleSub: "Green days have open slots. Pick a time below.",
    datesLabel: "Date",
    timesLabel: "Time",
    selectDate: "Select a date",
    selectTime: "Select a time",
    partOfDay: "Part of day",
    scanningDates: "Finding the next available day…",
    noSlotsInBand: "No slots in this part of the day. Try All.",
  ...
  pro: {
    ...
    onboardingWizard: {
      ...
      newbornExperience: "Newborn experience",
      firstAid: "First-aid training",
      ageGroups: { newborn: "Newborn", toddler: "Toddler", school: "School age" },
      ...
      accuracyConfirm: "I confirm this information is accurate.",
      submit: "Submit application",
      submitIncomplete: "Please complete all required sections before submitting.",
      saveError: "Could not save this section. Please try again.",
      uploadError: "Upload failed. Check file type and size (max 10 MB).",
      uploadStorageError: "Photo uploaded to storage but could not be linked. Try again.",
      uploadProfileError: "Photo saved but profile could not be updated. Try again.",
      uploadDocumentError: "Profile updated but verification record failed. Try uploading again.",
      readOnly: "Your application is being reviewed.",
      changesRequired: "Please update the items noted by our team and resubmit.",
      status: {
        SUBMITTED: "Submitted",
      ...
      statusBody: {
        SUBMITTED: "We received your application. You'll be notified when review starts.",
        UNDER_REVIEW: "Our team is reviewing your application.",
        REJECTED: "Your application was not approved. Contact support if you have questions.",
        SUSPENDED: "Your provider account is temporarily suspended.",
      },
      errors: {
        legal_name_required: "Legal name is required.",
        personal_details_incomplete: "Complete all personal details.",
        profile_photo_required: "Profile photo is required.",
        service_required: "Select at least one service.",
        experience_incomplete: "Complete experience information.",
        babysitting_details_required: "Complete babysitting details.",
        zone_required: "Select at least one service zone.",
        two_references_required: "Two references are required.",
        reference_required: "Add at least one reference.",
        national_id_required: "National ID front and back are required.",
        accuracy_confirmation_required: "Confirm your information is accurate.",
      },
    },
    profile: {
      title: "Profile",
  ...
  admin: {
    ...
    provider: {
      ...
      notEligibleBody: "This provider is not visible to customers. Reasons below.",
      eligVerified: "Verified",
      eligActive: "Account active (not suspended)",
      eligApprovedService: "Has an approved, active service",
    ...
    cases: {
      ...
      assigning: "Assigning…",
      assigned: "Assigned",
      assignmentError: "Could not assign this case.",
    ...
    promoCodes: {
      ...
      featuredHint: "Show on the customer Home screen and promo list",
    ...
    zones: {
      ...
      polygonMode: "Polygon",
      circleMode: "Circle (legacy)",
      polygonTooFewPoints: "Add at least 3 points to define the boundary.",
      overviewTitle: "All zones",
      overviewHint: "Every configured zone, shown together for context.",
      testAddress: "Test an address",
      testAddressHint: "Pick a point to check whether it falls inside this zone.",
      testResultInside: "Inside this zone",
      testResultOutside: "Outside this zone",
      overlapWarning: "This boundary overlaps with: {{names}}",
    ...
    settings: {
      ...
      billingLoadError: "Could not load billing settings.",
